...
# ---------------------------------------------------------------------------
def detect_spikes(
    v: np.ndarray, dt: float = 0.025, lockout_ms: float = 5.0
) -> np.ndarray:
    ...
    N: int
        Multiplier for the robust standard deviation to set the threshold.
    lockout_ms: float
    ...
    # Compute the robust standard deviation and dynamic threshold
